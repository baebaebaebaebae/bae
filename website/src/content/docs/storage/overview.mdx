...
|                              | Unmanaged        | Library home       | Cloud home         |
|------------------------------|------------------|--------------------|--------------------|
...
A managed release can have files in the library home, the cloud home, or both. The library home is the local copy; the cloud home is the encrypted remote copy. If you have a cloud home configured, managed imports go to both.
...
A release that only exists in the cloud home (e.g., synced from another device that hasn't downloaded it yet) is not available for offline playback until the files are pulled to the local library home.
