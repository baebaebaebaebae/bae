---
title: Sharing
description: Identity, membership chain, signed changesets, and share link tokens
---

This page covers the technical mechanisms behind sharing. For how to use these features, see [Share](/library/share), [Follow](/library/follow), and [Collaborate](/library/collaborate).
