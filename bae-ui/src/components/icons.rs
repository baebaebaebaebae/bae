...
/// Volume 2 icon (speaker with two arcs - high volume)
#[component]
pub fn Volume2Icon(#[props(default = "w-4 h-4")] class: &'static str) -> Element {
    rsx! {
        svg {
            class: "{class}",
            xmlns: "http://www.w3.org/2000/svg",
...
/// Volume 1 icon (speaker with one arc - low volume)
#[component]
pub fn Volume1Icon(#[props(default = "w-4 h-4")] class: &'static str) -> Element {
    rsx! {
        svg {
            class: "{class}",
            xmlns: "http://www.w3.org/2000/svg",
...
/// Volume X icon (speaker with X - muted)
#[component]
pub fn VolumeXIcon(#[props(default = "w-4 h-4")] class: &'static str) -> Element {
    rsx! {
        svg {
            class: "{class}",
            xmlns: "http://www.w3.org/2000/svg",
